...
# 3. Open Kismet in Chrome (login: kismet / REDACTED_PASS)
...
# Test Kismet
curl -s -u kismet:REDACTED_PASS http://10.211.55.10:2501/system/status.json | python3 -c "import sys,json;d=json.load(sys.stdin);print(f'Kismet Devices: {d[\"kismet.system.devices.count\"]}')"
```

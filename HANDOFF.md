...
| **Severity** | 10 (Maximum) |
| **Target AP** | `C6:4F:D5:DE:3B:42` - "REDACTED_SSID" (neighbor's Cox router, WPA3-SAE) |
...
2. **Target Network**: "REDACTED_SSID" is a Cox Communications multi-SSID router with open "CoxWiFi" guest network
...
- Added `C6:4F:D5:DE:3B:42` to watchlist as `REDACTED_SSID-ATTACK-TARGET`
- Added `58:D5:0A:A7:5A:A8` to watchlist as `REDACTED_SSID-CLIENT-VICTIM`
...
C6:4F:D5:DE:3B:42  REDACTED_SSID-ATTACK-TARGET     Neighbor AP
58:D5:0A:A7:5A:A8  REDACTED_SSID-CLIENT-VICTIM     Neighbor Client
```
...
- **Kismet Credentials**: `kismet` / `REDACTED_PASS`
...
cd /Users/REDACTED/my_projects/0_active_projects/Chasing-Your-Tail-NG
export CYT_VM_API_KEY="REDACTED_API_KEY"
python3 cyt_proxy_server.py &

# 2. Open dashboard in Chrome
open -a "Google Chrome" "http://localhost:8080/"

# 3. Open Kismet in Chrome (via proxy - login: kismet / REDACTED_PASS)
...
|----------|---------|-------|
| `CYT_VM_API_KEY` | Authenticate to VM API | `REDACTED_API_KEY` |
...
|------|------|--------|--------------|--------|
| 07:52-07:58 | DEAUTHFLOOD | REDACTED_SSID (C6:4F:D5:DE:3B:42) | DC:56:7B:C2:E5:18 | STOPPED |

...
- Configured Kismet HTTP credentials (username: `kismet`, password: `REDACTED_PASS`)
...
curl -s -u kismet:REDACTED_PASS http://localhost:8080/kismet/system/status.json | python3 -c "import sys,json;d=json.load(sys.stdin);print(f'Kismet Devices: {d[\"kismet.system.devices.count\"]}')"
```
